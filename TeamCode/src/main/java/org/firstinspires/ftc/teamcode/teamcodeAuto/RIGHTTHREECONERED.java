...
@Disabled
@Autonomous(name = "RIGHTTHREECONERED")
public class RIGHTTHREECONERED extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj1 = robot.trajectoryBuilder(startBlueLeft)
                ...
                .splineTo(new Vector2d(-36, 7), Math.toRadians(178))
                .build();
        //Strafes left
        ...
        if (tagOfInterest == null) {
            ...
            robot.placeConeRight();
            robot.turnSlightly(true, true, this);
            robot.grabCone(0.0512, 140);
            robot.turnSlightly(false, true, this);
            robot.placeConeRight();
            robot.turnSlightly(true, true, this);
            robot.grabCone(0.0487, 140);
            robot.turnSlightly(false, true, this);
            robot.placeConeRight();
            robot.setArm(0.09);
            robot.turnForTime(true, 500);
