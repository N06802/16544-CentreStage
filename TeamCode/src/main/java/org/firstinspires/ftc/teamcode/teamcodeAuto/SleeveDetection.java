...
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static final Scalar
            lower_yellow_bounds  = new Scalar(220, 220, 0, 255),
            upper_yellow_bounds  = new Scalar(255, 255, 50, 255),
            lower_cyan_bounds    = new Scalar(0, 220, 220, 255),
            upper_cyan_bounds    = new Scalar(50, 255, 255, 255),
            lower_magenta_bounds = new Scalar(220, 0, 220, 255),
            upper_magenta_bounds = new Scalar(255, 50, 255, 255);
