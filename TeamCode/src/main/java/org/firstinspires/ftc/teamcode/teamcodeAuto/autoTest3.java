...
public class autoTest3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (tagOfInterest == null) {
            ...
            robot.grabCone(0.0535, 100);
            robot.turnSlightly(false, false, this);
            robot.placeCone();
            robot.turnSlightly(true, false, this);
            robot.grabCone(0.0515, 50);
            robot.turnSlightly(false, false, this);
            robot.placeCone();
            robot.setArm(0.09);
            robot.turnForTime(false, 1500);
            robot.goForward(500);
            //robot.turn(15);
            ...
            robot.placeCone();
            robot.turnSlightly(true, true, this);
            robot.grabCone(0.0535, 100);
            robot.turnSlightly(false, true, this);
            robot.placeCone();
            robot.turnSlightly(true, true, this);
            ...
            robot.placeCone();
            robot.setArm(0.09);
            robot.turnForTime(true, 1500);


            if (tagPos == 1) {
                robot.strafeForTime(true, 2000);
            } else if (tagPos == 3) {
                robot.strafeForTime(false, 2000);
            }
            robot.goForward(500);
        }
    }
