...
public class autoTest2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj1 = robot.trajectoryBuilder(startBlueLeft)
                ...
                .splineTo(new Vector2d(36, 7), Math.toRadians(-2))
                .build();
        //Strafes left
        /*Trajectory traj2 = robot.trajectoryBuilder(traj1.end())
                ...
                .build();*/
        //strafes right
        Pose2d startConeStack = new Pose2d();
        ...
        if (tagOfInterest == null) {
            ...
            //robot.grabCone(0.32);
            robot.turnSlightly(false, false, this);
            robot.placeCone();
            robot.turnSlightly(true, false, this);
            robot.grabCone(0.0515, 100);
            robot.turnSlightly(false, false, this);
            robot.placeCone();
            robot.turnSlightly(true, false, this);
            robot.grabCone(0.0495, 100);
            robot.turnSlightly(false, false, this);
            robot.placeCone();
            robot.setArm(0.09);
            robot.turnForTime(false, 500);
            robot.goBackward(250);
            robot.turnForTime(false, 600);
            robot.goForward(250);
            //robot.turn(15);
            ...
            robot.placeCone();
            robot.turnSlightly(true, false, this);
            robot.grabCone(0.051, 100);
            robot.turnSlightly(false, false, this);
            robot.placeCone();
            robot.turnSlightly(true, false, this);
            robot.grabCone(0.047, 50);
            robot.turnSlightly(false, false, this);
            robot.placeCone();
            robot.setArm(0.09);
            robot.turnForTime(false, 500);
            ...
            if (tagPos == 1) {
                robot.goForward(1500);
                robot.turnForTime(false, 1000);
                robot.goForward(500);
            } else if (tagPos == 3) {
                robot.goBackward(2000);
                robot.turnForTime(false, 1000);
                robot.goForward(500);
            } else {
                robot.goBackward(500);
                robot.turnForTime(false, 1000);
                robot.goForward(500);
            }
        }
